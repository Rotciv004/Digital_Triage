...
/// </summary>
public sealed record StatisticsFiltersDto
{
    public required List<LocationOptionDto> Countries { get; init; }
    public required List<LocationOptionDto> Counties { get; init; }
    public required List<LocationOptionDto> Cities { get; init; }
    public required List<HospitalOptionDto> Hospitals { get; init; }
    public required List<string> ProblemTypes { get; init; }
}

/// <summary>
/// DTO for location filter options.
/// </summary>
public sealed record LocationOptionDto(int? Id, string Name);

/// <summary>
/// DTO for hospital filter options.
/// </summary>
...
{
    public required int TotalActiveIssues { get; init; }
    public required int UniquePatientsWithActiveIssues { get; init; }
    public required int HospitalsIncluded { get; init; }
    public required Dictionary<string, int> DistributionBySeverity { get; init; }
    public required Dictionary<string, int> DistributionByType { get; init; }
    public required Dictionary<string, Dictionary<string, int>> TypeSeverityMatrix { get; init; }
    public required List<TopHospitalDto> TopHospitals { get; init; }
}

/// <summary>
/// DTO for top hospital statistics.
/// </summary>
public sealed record TopHospitalDto(int HospitalId, string HospitalName, int ActiveIssuesCount, int UniquePatientsCount);
